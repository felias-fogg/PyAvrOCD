...
- Then it will connect to bookworm.fogg (a virtual i686 machine) and produce the i686-linux-gnu version of PyAvrOCD, which will be copied to the corresponding binary folder.
